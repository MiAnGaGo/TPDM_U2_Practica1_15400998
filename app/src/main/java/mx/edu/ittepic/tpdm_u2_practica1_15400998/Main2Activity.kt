...
class Main2Activity : AppCompatActivity() {
    ...
    var encListEnTar : TextView ?= null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        encListEnTar = findViewById(R.id.encListEnTar)
    ...
    fun insertarTareas(idtarea: String) {
        try {
            ...
            msj("Error!", "No se pudo insertar el registro, datos incorrectos y/o \"ID Lista\" no existe")
        }
    }
    ...
    fun mostrarTodosList(){
        ...
        try {
            ...
            encListEnTar?.setText(encEnLiTa)
            if(cur != null){
    ...
    fun buscar(id: String, btnEtiqueta: String){
        try {
            ...
            if (cur.moveToFirst()==true){
                ...
                msj("Error!","No existe el id: ${id}")
            }
        }catch (err: SQLException){
            msj("Error!","No se encontro el registro")
        }
    }
    ...
    fun eliminar(id:String){
        try{
            ...
            trans.execSQL(SQL)
            trans.close()
            msj("Exito!", "Se elimino correctamente el id: ${id}")
        }catch (err: SQLException){
            msj("Error!", "No se pudo eliminar")
